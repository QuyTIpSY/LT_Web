...
namespace _19T1021205.DataLayers.SQLServer
{
    ...
    public class OrderDAL : _BaseDAL, IOrderDAL
    {
        ...
        //IList<Order> IOrderDAL.List(int page, int pageSize, int status, string searchValue)
        //{
        //    throw new NotImplementedException();
        //}

        //Order IOrderDAL.Get(int orderID)
        //{
        //    throw new NotImplementedException();
        //}
        ...
        //IList<OrderDetail> IOrderDAL.ListDetails(int orderID)
        //{
        //    throw new NotImplementedException();
        //}

        //OrderDetail IOrderDAL.GetDetail(int orderID, int productID)
        //{
        //    throw new NotImplementedException();
        //}

        public IList<OrderStatus> ListOfStatus()
        {
