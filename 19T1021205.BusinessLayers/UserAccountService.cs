...
namespace _19T1021205.BusinessLayers
{
    ...
    public static class UserAccountService
    {
        ...
        static UserAccountService()
        {
            ...
            employeeAccountDB = new _19T1021205.DataLayers.SQLServer.EmployeeAccountDAL(connectionString);
            customerAccountDB = new _19T1021205.DataLayers.SQLServer.CustomerAccountDAL(connectionString);
        }
